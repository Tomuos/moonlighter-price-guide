...

{
  ...
  // 🏹 2. Hero's Bow (Fixed to match Hero's Sword layout style)
  {
    id: "heros-bow",
    name: "Hero's Bow",
    kind: "weapons",
  ...
  // 🗡️ 3. Hero's Sword (Kept intact - your reference structure)
  {
    id: "heros-sword",
    name: "Hero's Sword",
    kind: "weapons",
  ...
  // 🪓 5. Ragnarok Big Sword (Fixed trailing layout clip)
  {
    ...
    enchantments: [
      {
        ...
        cost: [
          { itemName: "Dimensional Garbage", quantity: 3 },
          { itemName: "Dimensional Resistant Metal", quantity: 2 },
          { itemName: "Mercury Drops", quantity: 5 },
        ],
      },
      { tier: 2, bonus: "Level II · Damage 960" },
      { tier: 3, bonus: "Level III · Damage 1488" },
